...
class questionAnswerController
{
    ...
    public function __construct($ref=null)
    {
        ...
        include_once(Config::$admin_path.'class/questionAnswer.class.php');
        $this->utils=new Utils();
        $this->questionAnswer=new QuestionAnswer('questionAnswer');
    ...
    public function details()
    {
        ...
        $response=$this->questionAnswer->getDetails($this->page,$this->limit,$this->sidx,$this->sord,$wh);
    ...
    public function operation()
    {
        ...
        /* ADD */
        if($oper=='add'){
            $response=$this->questionAnswer->addDetails(
                $this->utils->checkValues($_POST['question_text']),
                $this->utils->checkValues($_POST['answer_text']),
                $this->utils->checkValues($_POST['answer_order'])
            );
            if($response){
                $status=TRUE;
        ...
        /* EDIT */
            ...
            $response=$this->questionAnswer->editDetails(
                $this->utils->checkValues($_POST['question_text']),
                $this->utils->checkValues($_POST['answer_text']),
                $this->utils->checkValues($_POST['answer_order']),
        ...
        /* DELETE */
            ...
            $response=$this->questionAnswer->deleteDetails($this->utils->checkValues($_POST['id']));
            if($response){
                $status=TRUE;
    ...
    {
        $response= $this->questionAnswer->getSelect();
...
{
    $questionAnswerController=new QuestionAnswerController($_REQUEST['ref']);
}
?>