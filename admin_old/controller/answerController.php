...
class answerController
{
    ...
    public function __construct($ref=null)
    {
        ...
        include_once(Config::$admin_path.'class/answer.class.php');
    ...
    public function details()
    {
        ...
        $response=$this->answer->getDetails($this->page,$this->limit,$this->sidx,$this->sord,$wh);
    ...
    public function operation()
    {
        ...
        /* ADD */
        if($oper=='add'){
            $response=$this->answer->addDetails($this->utils->checkValues($_POST['answer_text']));
            if($response){
                $status=TRUE;
        ...
        /* EDIT */
            ...
            $response=$this->answer->editDetails($this->utils->checkValues($_POST['answer_text']),$this->utils->checkValues($_POST['id']));
            if($response){
                $status=TRUE;
        ...
        /* DELETE */
            ...
            $response=$this->answer->deleteDetails($this->utils->checkValues($_POST['id']));
            if($response){
                $status=TRUE;
    ...
    {
        $response= $this->answer->getSelect();
...
{
    $answerController=new AnswerController($_REQUEST['ref']);
}
?>