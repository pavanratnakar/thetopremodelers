            ...
            <div class="main-content-container clearfix">
                <div class="header">
                    ...
                    <div class="back-button clearfix">
                        <a class="clearfix" title="Back" href="<?php echo Config::$site_url.'place/'.$placeName ?>">
                ...
                <div class="content clearfix">
                    <div class="main left">
                        <h2>Get Matched to Top-Rated<br/><?php echo $categoryDetails[0]['category_title']?> for <?php echo $placeDetails['place_title']; ?></h2>
                        <ul>
