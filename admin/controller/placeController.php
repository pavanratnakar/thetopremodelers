...
class placeController {
    ...
    public function __construct($ref=null){
        ...
        include_once(Config::$admin_path.'class/place.class.php');
    ...
    public function details(){
        ...
        $response=$this->place->getDetails($this->page,$this->limit,$this->sidx,$this->sord,$wh);
    ...
    public function operation(){
        ...
        /* EDIT */
            ...
            $response=$this->place->editDetails(
                $this->utils->checkValues($_POST['place_name']),
                $this->utils->checkValues($_POST['place_title']),
                $this->utils->checkValues($_POST['under']),
                $this->utils->checkValues($_POST['place_geo']),
        ...
        /* DELETE */
            ...
            $response=$this->place->deleteDetails($this->utils->checkValues($_POST['id']));
            if($response){
                $status=TRUE;
...
if(isset($_REQUEST['ref'])){
    $placeController=new PlaceController($_REQUEST['ref']);
}
?>