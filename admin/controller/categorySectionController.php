...
class categorySectionController{
    ...
    public function __construct($ref=null){
        ...
        include_once(Config::$admin_path.'/class/categorySection.class.php');
        $this->utils=new Utils();
        $this->categorySection=new CategorySection('categorySection');
    ...
    public function details(){
        if(isset($_REQUEST['_search']) && $this->searchOn!='false') {
            ...
            if( $fld=='place_title' || $fld=='category_title' || $fld=='section_title' || $fld=='categorysection_order' || $fld=='active') {
        ...
        $response=$this->categorySection->getDetails($this->page,$this->limit,$this->sidx,$this->sord,$wh);
    ...
    public function operation(){
        ...
        /* DELETE */
            ...
            $response=$this->categorySection->deleteDetails($this->utils->checkValues($_POST['id']));
            if($response){
                $status=TRUE;
    ...
    public function select(){
        $response= $this->categorySection->getSelect($this->utils->checkValues($_GET['placeCategory_id'],$this->utils->checkValues($_GET['returnType'])));
...
if(isset($_REQUEST['ref'])){
    $categorySectionController=new CategorySectionController($_REQUEST['ref']);
}
?>